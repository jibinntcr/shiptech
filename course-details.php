        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100"
                            src="uploads/<?php echo htmlentities($userArr[0]->image); ?>"
                ...
                <div class="col-lg-6 about-text wow fadeInUp ship-contact-data" data-wow-delay="0.3s">
                    ...
                    <p class="mb-5" style="margin-left: 15px;"><i class="fa fa-ship me-3" aria-hidden="true"
                            style="color:#007a9b"></i><?php echo htmlentities($userArr[0]->seat); ?></p>
                    ...
                    <ul class="mission-dot " style=" margin-left: 15px;">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="white col-11" href="<?php echo $syllabus1 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus2 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus3 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus4 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus5 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus6 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus7 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus8 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus9 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus10 ?>"
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus11 ?>"
                                target="_blank"><?php echo $userArr[0]->syllabus11 ?></a>
                        </li>
                        <?php }
                            ?>
                        <!-- Syllebus 11 end  -->
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus12 ?>"
                                target="_blank"><?php echo $userArr[0]->syllabus12 ?></a>
                        </li>
                        <?php }
                            ?>
                        <!-- Syllebus 12 end  -->
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus13 ?>"
                                target="_blank"><?php echo $userArr[0]->syllabus13 ?></a>
                        </li>
                        <?php }
                            ?>
                        <!-- Syllebus 13 end  -->
                        ...
                        <li class="mb-2">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus14 ?>"
                                target="_blank"><?php echo $userArr[0]->syllabus14 ?></a>
                        </li>
                        <?php }
                            ?>
                        <!-- Syllebus 14 end  -->
                        ...
                        <li class="">
                            <i class="fa fa-ship " aria-hidden="true" style="color:#007a9b"></i>
                            <a class="white col-11" href="<?php echo $syllabus15 ?>"
                                target="_blank"><?php echo $userArr[0]->syllabus15 ?></a>
                        </li>
                        <?php }
                            ?>
                        <!-- Syllebus 15 end  -->
