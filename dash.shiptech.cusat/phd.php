...
?>
    ...
    <head>
        ...
        <title>PhD | Ship Technology CUSAT</title>
        <!-- plugins:css -->
                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        <button onclick="location.href = 'researchguide.php';" type="button" class="btn btn-primary btn-lg btn-block">
                                            <h4>Research Guide</h4>
                                        </button>
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <button onclick="location.href = 'regulations.php';" type="button" class="btn btn-primary btn-lg btn-block">
                                            <h4>Regulations</h4>
                                        </button>
                                    </div>
                                    <div class="col-md-4 mb-4">
                                        <button onclick="location.href = 'currentscholers.php';" type="button" class="btn btn-primary btn-lg btn-block">
