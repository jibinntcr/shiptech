...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['workshopBTN'])) {
        ...
        $status = '1';
        $sql = "INSERT INTO workshop(name,year,link,status,image) VALUES ('" . $name . "','" . $year . "','" . $link . "','" . $status . "','" . $photo . "')";
...
?>
    ...
    <head>
        ...
        <title>New Workshop | Ship Technology Admin</title>
        <!-- plugins:css -->
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">New Workshop</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" name="workshopBTN" id="workshopBTN">Submit</button>
