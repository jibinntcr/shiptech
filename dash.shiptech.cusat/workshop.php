                                ...
                                <div class="col-12 col-xl-4">
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button onclick="location.href = 'new-workshop.php';" type="button"
                                            ...
                                            <tr><?php
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        <button
                                                            onclick="location.href = 'workshop-edit.php?id=<?php echo   $result->id ?>';"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        <a href="workshopstatusactivate.php?idE=<?php echo   $idE ?>"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        ...
                                                        <a href="workshopstatusactivate.php?idD=<?php echo   $idD ?>"
