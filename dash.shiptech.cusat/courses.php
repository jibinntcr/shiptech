...
?>
    ...
    <head>
        ...
        <title>Courses | Ship Technology Admin</title>
        <!-- plugins:css -->
                                                ...
                                                ?>
                                                        <tr><?php
                                                            ...
                                                            if ($status == 1) {
                                                                ...
                                                                <td>
                                                                    <div class="template-demo mt-2">
                                                                        <a href="coursestatusactivate.php?idE=<?php echo   $idE ?>" type="button" class="btn btn-success btn-sm" name="statusBTN" id="statusBTN">Disable</a>
                                                                    </div>
                                                                </td>
                                                            <?php
                                                            } else {
                                                                ...
                                                                <td>
                                                                    <div class="template-demo mt-2">
                                                                        ...
                                                                        <a href="coursestatusactivate.php?idD=<?php echo   $idD ?>" type="button" class="btn btn-danger btn-sm" name="statusBTN" id="statusBTN">Enable</a>
                                                                    </div>
                                                                </td>
                                                            <?php
                                                            }
