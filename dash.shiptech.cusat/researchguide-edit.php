...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['ResearchGuideEditBTN'])) {
...
<head>
    ...
    <title>Edit Announcement | Shiptech Admin</title>
    <!-- plugins:css -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    <?php
                                        $id = $_GET['id'];
                                        $sql = "SELECT * from researchguide where id=$id ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="area" name="Editarea"
                                            rows="4"><?php echo htmlentities($userArr[0]->area); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="file" id="file" name="file"
                                            accept="image/gif, image/png, image/jpg, image/jpeg">
                                    </div>
                                    <button type="submit" class="btn btn-primary mr-2" name="ResearchGuideEditBTN"
                                        id="ResearchGuideEditBTN">Save</button>
