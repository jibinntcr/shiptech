                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="area" name="Editarea" rows="4"><?php echo htmlentities($userArr[0]->area); ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="file" id="file" name="file" accept="image/gif, image/png, image/jpg, image/jpeg">
                                            </div>
                                            <button type="submit" class="btn btn-primary mr-2" name="ResearchGuideEditBTN" id="ResearchGuideEditBTN">Save</button>
