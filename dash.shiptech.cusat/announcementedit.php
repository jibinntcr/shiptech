...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['announcementEditBTN'])) {
        ...
        // exit();
        $status = '1';
        $sql = "UPDATE  announcement SET announcements=' $announcement',link='$link',date='$date' where id='$id'";
        // print_r($sql);
        // exit();
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST">
                                    <?php
                                        ...
                                        // print_r($id);
                                        // exit();
                                        $sql = "SELECT id,announcements,link,date from announcement where id=$id ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Editannouncement"
                                            name="Editannouncement"
                                            value="<?php echo htmlentities($userArr[0]->announcements); ?>">
                                    </div>
                                    <div class="form-group">
                                        <!-- <label for="exampleInputUsername1"></label> -->
                                        <input type="date" class="form-control" id="date" name="date"
                                            value="<?php echo ($userArr[0]->date); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="announcementEditBTN"
                                        id="announcementEditBTN">Save</button>
