...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['hodUpdateBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $sql = "UPDATE  hod SET name='$name',message='$message',designation='$designation',photo='$photo' where id='$id'";
...
?>
    ...
    <head>
        ...
        <title>New HOD | Ship Technology Admin</title>
        <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        // print_r($id);
                                        // exit();
                                        $sql = "SELECT id,name,message,designation,photo from hod where id= $id ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                        ...
                                        ?>
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id="imageName" name="imageName" value="<?php echo htmlentities($userArr[0]->photo); ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="designation" name="designation" value="<?php echo htmlentities($userArr[0]->designation); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea1">Message</label>
                                                <textarea class="form-control" id="message" name="message" rows="4"><?php echo htmlentities($userArr[0]->message); ?></textarea>
                                            </div>
                                            <div class="form-group">
