...
?>
    ...
    <head>
        ...
        <title>Banner Edit | Ship Technology Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="topCaption" name="topCaption" value="<?php echo htmlentities($userArr[0]->topCaption); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="mainCaption" name="mainCaption" value="<?php echo htmlentities($userArr[0]->mainCaption); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Sub Caption</label>
                                                <input type="text" class="form-control" id="subCaption" name="subCaption" value="<?php echo htmlentities($userArr[0]->subCaption); ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="BannerUpdateBTN" id="BannerUpdateBTN">Save</button>
