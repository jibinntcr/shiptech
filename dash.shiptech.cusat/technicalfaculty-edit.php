...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['technicalfacEditBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            $id = $_POST['id'];
            $name = $_POST['name'];
            $designation = $_POST['designation'];
            $photo = $_POST['imageName'];
            $sql = "UPDATE  technicalstaff SET name='$name',designation='$designation',image='$photo' where id='$id'";
            $query = $dbh->prepare($sql);
            $result = $query->execute();
            if ($query->rowCount() > 0) {
                echo '<script>alert("Success")</script>';
                echo '<script>window.location = "technicalfaculty.php";</script>';
            } else {
...
?>
    ...
    <head>
        ...
        <title>Edit Other Staff | Ship Technology Admin</title>
        <!-- plugins:css -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="technicalfacEditBTN" id="technicalfacEditBTN">Save</button>
