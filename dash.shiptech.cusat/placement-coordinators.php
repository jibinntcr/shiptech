...
<head>
    ...
    <title>Placement Coordinators | Ship Technology Admin</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Placement Coordinators</h3>
                                </div>
                                <div class="col-12 col-xl-4">
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button onclick="location.href = 'new-placement-coordinators.php';"
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * from placemencordinators";
                                            ...
                                            <tr><?php
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        <button
                                                            onclick="location.href = 'placement-coordinators-edit.php?id=<?php echo   $result->id ?>';"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        <a href="placementcoordinatorsactivate.php?idE=<?php echo   $idE ?>"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        ...
                                                        <a href="placementcoordinatorsactivate.php?idD=<?php echo   $idD ?>"
