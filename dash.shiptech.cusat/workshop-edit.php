...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['workshopEditBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $year = $_POST['EditYear'];
            $link = $_POST['EditLink'];
            $sql = "UPDATE  workshop SET name='$name',year='$year',link='$link',image='$photo' where id='$id'";
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit Workshops</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="workshopEditBTN" id="workshopEditBTN">Save</button>
