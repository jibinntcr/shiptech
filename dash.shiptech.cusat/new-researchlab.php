...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['researchlabBTN'])) {
        ...
        $status = '1';
        $sql = "INSERT INTO researchlab(name,content,facility2,facility3,facility4,facility5,facility6,facility7,facility8,facility9,facility10,status,image) VALUES ('" . $name . "','" . $facilities . "','" . $facility2 . "','" . $facility3 . "','" . $facility4 . "','" . $facility5 . "','" . $facility6 . "','" . $facility7 . "','" . $facility8 . "','" . $facility9 . "','" . $facility10 . "','" . $status . "','" . $photo . "')";
...
?>
    ...
    <head>
        ...
        <title>New Research Lab | Ship Technology Admin</title>
        <!-- plugins:css -->
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">New Research Lab</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" name="researchlabBTN" id="researchlabBTN">Submit</button>
