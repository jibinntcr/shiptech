...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['researchscholarBTN'])) {
        ...
        $title = $_POST['title'];
        $year = $_POST['year'];
        $scholarstatus = $_POST['scholarstatus'];
        $status = '1';
        $sql = "INSERT INTO researchscholar(reg,name,guide,year,scholarstatus,status,title) VALUES ('" . $renumber . "','" . $name . "','" . $guide . "','" . $year . "','" . $scholarstatus . "','" . $status . "','" . $title . "')";
...
<head>
    ...
    <title>New Scholar | Shiptech Admin</title>
    <!-- plugins:css -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="researchscholarBTN"
                                        id="researchscholarBTN">Submit</button>
