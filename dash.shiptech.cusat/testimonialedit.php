                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="EditYear" name="EditYear"
                                            value="<?php echo htmlentities($userArr[0]->batch); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="Message">Message</label>
                                        <textarea class="form-control" id="Editmessage" name="Editmessage"
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="testimonialEditBTN"
                                        id="testimonialEditBTN">Save</button>
