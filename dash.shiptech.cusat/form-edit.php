...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['FormFestEditBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $name = $_POST['EditName'];
            $year = $_POST['EditYear'];
            $sql = "UPDATE  techfest SET name='$name',year='$year',image='$photo' where id='$id'";
...
?>
    ...
    <head>
        ...
        <title>Edit Form | Ship Technology Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="EditYear" name="EditYear" value="<?php echo htmlentities($userArr[0]->year); ?>">
                                            </div>

                                            <div class="form-group">
                                                <input type="file" id="file" name="file" accept="application/pdf">
                                            </div>
                                            <button type="submit" class="btn btn-primary mr-2" name="FormFestEditBTN" id="FormFestEditBTN">Save</button>
