                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="EditYear" name="EditYear"
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="FormFestEditBTN"
                                        id="FormFestEditBTN">Save</button>
