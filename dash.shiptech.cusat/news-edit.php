...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['newsUpdateBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $sql = "UPDATE  news SET title='$title',content='$content',date='$date',image='$photo',slug='$slug' where id='$id'";
...
?>
    ...
    <head>
        ...
        <title>Edit News | Ship Technology Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            <div class="col-lg-12 form-group">
                                                ...
                                                <input type="hidden" id="oldDate" name="oldDate" value="<?php echo htmlentities($userArr[0]->date); ?>" />

                                                <label for="exampleInputUsername1">Heading</label>
                                                <input type="text" class="form-control" id="title" name="title" value="<?php echo htmlentities($userArr[0]->title); ?>">
                                            </div>

                                            <div class="col-lg-6 form-group">
                                                <label for="exampleInputUsername1">Date</label>
                                                <input type="date" class="form-control" id="date" name="date" value="<?php echo htmlentities($userArr[0]->date); ?>">
                                            </div>
                                            <div class="col-lg-12 form-group">
                                                <label for="exampleTextarea1">Content</label>
                                                <textarea class="form-control" id="content" name="content" rows="4"><?php echo htmlentities($userArr[0]->content); ?></textarea>
                                            </div>
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="newsUpdateBTN" id="newsUpdateBTN">Save</button>
