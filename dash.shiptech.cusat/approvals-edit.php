...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['mouEditBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $name = $_POST['EditName'];
            $year = $_POST['EditYear'];
            $sql = "UPDATE  approvals SET name=' $name',year='$year',image='$photo' where id='$id'";
...
?>
    ...
    <head>
        ...
        <title>Edit Approvals | Ship Technology Admin</title>
        <!-- plugins:css -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit Approvals</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "SELECT * from approvals where id=$id ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
