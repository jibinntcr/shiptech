...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['technicalstaffBTN'])) {
        $name = $_POST['name'];
        ...
        $status = '1';
        $sql = "INSERT INTO technicalstaff(name,designation,type,status,image) VALUES ('" . $name . "','" . $designation . "','" . $stafftype . "','" . $status . "','" . $photo . "')";
...
?>
    ...
    <head>
        ...
        <title>New Other Staff | Ship Technology Admin</title>
        <!-- plugins:css -->
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">New Other Staff</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" name="technicalstaffBTN" id="technicalstaffBTN">Submit</button>
