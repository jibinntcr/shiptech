...
<head>
    ...
    <title>New Placement Brochure | Ship Technology Admin</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">New Placement Brochure</h4>
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="approvalBTN"
                                        id="approvalBTN">Submit</button>
