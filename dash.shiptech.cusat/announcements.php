...
<head>
    ...
    <title>Announcement | Shiptech Admin</title>
    <!-- plugins:css -->
                                ...
                                <div class="col-12 col-xl-4">
                                    <div class="justify-content-end d-flex">
                                        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                            <button onclick="location.href = 'new-announcement.php';" type="button"
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * from announcement where dlt_status = 0 ";
                                            ...
                                            <tr><?php
                                                ...
                                                <td>
                                                    <input type="hidden" id="userid" name="userid"
                                                        value="<?php echo htmlentities($result->announcements); ?>" />
                                                    <div class="template-demo mt-2">
                                                        <button
                                                            onclick="location.href = 'announcementedit.php?id=<?php echo   $result->id ?>';"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        <a href="statusactivate.php?idE=<?php echo   $idE ?>"
                                                ...
                                                <td>
                                                    <div class="template-demo mt-2">
                                                        ...
                                                        <a href="statusactivate.php?idD=<?php echo   $idD ?>"
