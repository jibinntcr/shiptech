...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['announcementBTN'])) {
        ...
        $link = $_POST['link'];
        $status = '1';
        $sql = "INSERT INTO announcement(announcements,link,status) VALUES ('" . $announcement . "','" . $link . "','" . $status . "')";
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="announcement" name="announcement" placeholder="Announcement">
                                        </div>
                                        <div class="form-group">
                                            <!-- <label for="exampleInputUsername1">Link</label> -->
                                            <input type="text" class="form-control" id="link" name="link" placeholder="Link">
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2" name="announcementBTN" id="announcementBTN">Submit</button>
