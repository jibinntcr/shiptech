...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['confEditBTN'])) {
        if (($_FILES["file"]["error"]) == 4) {
            ...
            $sql = "UPDATE  conference SET name='$name',year='$year',link='$link',eventStatus='$eventStatus',image='$photo' where id='$id'";
...
?>
    ...
    <head>
        ...
        <title>Edit Conference | Ship Technology Admin</title>
        <!-- plugins:css -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit Conference</h4>
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="eventStatus" id="eventStatus" value="1" checked="">
                                                            Yes
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="eventStatus" id="eventStatus" value="0">
                                                            No
                                                            <i class="input-helper"></i></label>
                                                    </div>
                                                </div>
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="confEditBTN" id="confEditBTN">Save</button>
