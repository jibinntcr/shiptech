...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['placementBTN'])) {
        ...
        $status = '1';
        $sql = "INSERT INTO placement(name,year,company,image,status,course) VALUES ('" . $name . "','" . $year . "','" . $companyName . "','" . $photo . "','" . $status . "','" . $course . "')";
        // print_r($sql);
        // exit();
...
<head>
    ...
    <title>New Placement | ShiptechAdmin</title>
    <!-- plugins:css -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="placementBTN"
                                        id="placementBTN">Submit</button>
