...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['BannerUpdateBTN'])) {
        ...
        $sql = "UPDATE  placemencordinators SET name=' $name',category='$category',phone='$phone',email='$email' where id='$id'";
        // print_r($sql);
        // exit();
        ...
        if ($query->rowCount() > 0) {
            ...
            echo '<script>window.location = "placement-coordinators.php";</script>';
        } else {
...
<head>
    ...
    <title>Placement Coordinator Edit | Ship Technology Admin</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Placement Coordinator Edit</h4>
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    <?php
                                        $id = $_GET['id'];
                                        // print_r($id);
                                        // exit();
                                        $sql = "SELECT * from placemencordinators where id= $id ";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="category" name="category">
                                            <option><?php echo htmlentities($userArr[0]->category); ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="<?php echo htmlentities($userArr[0]->email); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Phone Number</label>
                                        <input type="text" class="form-control" id="phone" name="phone"
                                            value="<?php echo htmlentities($userArr[0]->phone); ?>">
                                    </div>
