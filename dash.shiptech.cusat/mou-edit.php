...
<head>
    ...
    <title>Edit MoU | Shiptech Admin</title>
    <!-- plugins:css -->
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="EditContent" name="EditContent"
                                            rows="4"><?php echo htmlentities($userArr[0]->description); ?></textarea>
                                    </div>
                                    <div class="form-group">
