...
<head>
    ...
    <title>Placement | Ship Technology CUSAT</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <button onclick="location.href = 'placement.php';" type="button"
                                        class="btn btn-primary btn-lg btn-block">
                                        <h4>Placed Students</h4>
                                    </button>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <button onclick="location.href = 'placement-coordinators.php';" type="button"
                                        class="btn btn-primary btn-lg btn-block">
