                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Faculty from Indian Navy ?</label>
                                            <select class="form-control" id="navfac" name="navfac" required="">
                                                <option>No</option>
                                                <option>Yes</option>
                                            </select>
                                        </div>
