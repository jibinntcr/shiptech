...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['FormBTN'])) {
        ...
        $status = '1';
        $sql = "INSERT INTO forms(name,year,status,image) VALUES ('" . $name . "','" . $year . "','" . $status . "','" . $photo . "')";
...
?>
    ...
    <head>
        ...
        <title>New Form | Ship Technology Admin</title>
        <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Form (PDF Only)</label>
                                            <input class="form-control" type="file" id="file" name="file" accept="application/pdf" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2" name="FormBTN" id="FormBTN">Submit</button>
