...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['TechFestBTN'])) {
        ...
        $status = '1';
        $sql = "INSERT INTO techfest(name,year,link,status,image) VALUES ('" . $name . "','" . $year . "','" . $link . "','" . $status . "','" . $photo . "')";
...
?>
    ...
    <head>
        ...
        <title>New Tech Fest | Ship Technology Admin</title>
        <!-- plugins:css -->
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">New Tech Fest</h4>
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleTextarea1">Image(600x400px)</label>
                                            <input class="form-control" type="file" id="file" name="file" accept="image/gif, image/png, image/jpg, image/jpeg" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2" name="TechFestBTN" id="TechFestBTN">Submit</button>
