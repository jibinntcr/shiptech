...
<head>
    ...
    <title>Edit Patent | Shiptech Admin</title>
    <!-- plugins:css -->
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="EditProjectName"
                                            ...
                                            value="<?php echo htmlentities($userArr[0]->projectname); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="course">Publication Date</label>
                                        <input type="text" class="form-control" id="EditPublicationDate"
                                            name="EditPublicationDate"
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="patentEditBTN"
                                        id="patentEditBTN">Save</button>
