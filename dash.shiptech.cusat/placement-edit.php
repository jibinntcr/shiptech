...
?>
    ...
    <head>
        ...
        <title>New Placement | Ship Technology Admin</title>
        <!-- plugins:css -->
                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company" name="company" value="<?php echo htmlentities($userArr[0]->company); ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary mr-2" name="placementUpdateBTN" id="placementUpdateBTN">Save</button>
