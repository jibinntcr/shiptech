                                    ...
                                    <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="priority" name="priority" value="<?php echo ($userArr[0]->priority); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleSelectGender">Faculty from Indian Navy ?</label>
                                                <select class="form-control" id="navfac" name="navfac">
                                                    <option><?php echo htmlentities($userArr[0]->navfac); ?></option>
                                                    <option>No</option>
                                                    <option>Yes</option>
                                                </select>
                                            </div>
