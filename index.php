...
<body style="box-flex-group: #d6d6d6;">
                                            ...
                                            <li>
                                                <div class="d-flex  border p-1 my-4 align-items-center max-w-665"
                                                    ...
                                                    <div class="circle  d-flex justify-content-center container">
                                                        <div class="cell">
                                                            >>>>>>> 0d04bdf81d5cdbba4e1f2a77a9009c375fbde8c9

                                                            <?php $date = $result->date;
                                                    $date = date_create($date);
                                                    ?>
                                                            <h3 class="text-white">
                                                                <?php echo date_format($date, "d"); ?></h3>
                                                        </div>
                                                        <div class="cell">
                                                            <h5 class="text-white">
                                                                <?php echo date_format($date, "M"); ?></h5>
                                                        </div>
                                                        <div class="cell">
                                                            <h6 class="text-white">
                                                                <?php echo date_format($date, "Y"); ?></h6>
                                                        </div>
                                                    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <<<<<<< HEAD <img class="position-absolute img-fluid w-100 h-100 fac-img-curv"
                            src="img/cusat.jpg" style="object-fit: cover;" alt="">
                            =======
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <<<<<<< HEAD <img class="position-absolute img-fluid w-100 h-100 fac-img-curv"
                            src="img/shiptech.jpg" style="object-fit: cover;" alt="">
                            =======
    ...
    if ($query->rowCount() > 0) {
    ?>
    <<<<<<< HEAD <div class="container-xxl py-5">
        <div class="container">
                                                ...
                                                <span class="left m-5">
                                                    ...
                                                    <div style="float: left; ">
                                                        <img class="speaker-image-border hod-img"
                                                            src="https://infinio.co.in/test/uploads/hodmessage_img.jpg"
                ...
                ?>
                                        ...
                                        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                                            <div class="service-item p-4 fac-img-curv">
                                                <div class="overflow-hidden mb-4">
                                                    <img class="fac-img-curv img-fluid"
                                                ...
                                                <a class="btn-slide mt-2"
                                                    href="course-details.php?id=<?php echo   $result->id ?>"><i
                                        ...
                                        <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                                            <div class="service-item p-4 fac-img-curv">
                                                ...
                                                <a class="btn-slide mt-2" href="phd.php"><i
                                                        class="fa fa-arrow-right"></i><span>Read
                                                        More</span></a>
                                            </div>
                                        </div>
                            ...
                            <div class="container-xxl py-5 d-none d-md-block ">
                                <div class="testimonial-section">
                                    <div class="container">
                                        <div class="row align-items-center justify-content-between">
                                            <div class="col-lg-4 mb-5 section-title" data-aos="fade-up"
                                                data-aos-delay="0">

                                                <h2 class="mb-4 font-weight-bold heading">Testimonials</h2>
                                                <p class="mb-4 justify-para">Experiences and feedback provided by our
                                                    esteemed alumni and
                                                    students
                                                    who have been
                                                    a vital part of our department.</p>
                                                <p><a class="btn btn-primary "><span class="fa fa-arrow-right"
                                ...
                                ?>
                                                    ...
                                                    <div class="custom-nav-wrap">
                                                        <a href="#" class="custom-owl-prev"><span
                                                                class="icon-keyboard_backspace"></span></a>
                                                        <a href="#" class="custom-owl-next"><span
                                                                class="icon-keyboard_backspace"></span></a>
                                                    </div>
                                                </div>
                            ...
                            <div class="container-xxl py-5  d-block d-md-none">
                                ...
                                ?>
                                                ...
                                                ?>
                                                                ...
                                                                <p id="remaining-text" class="d-none">
                                                                    <?php echo $remaining_text ?></p>
                                                                ...
                                                                <button id="read-more-btn" class="btn btn-primary">Read
                                                                    More</button>
                                                                <?php endif; ?>
                                                            </blockquote>
