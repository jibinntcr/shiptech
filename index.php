                    ...
                    <div class=" container2" style="box-shadow: 10px 10px 50px  #000839;border-radius: 20px;">
                        <ul style="padding-left:1rem;padding-right:1rem;">
                            ...
                            ?>
                                    ...
                                    <li>
                                        <div class="d-flex  border p-1 my-4 align-items-center max-w-665" style="border-radius: 20px;border-width: thin; max-width: 655px; margin: 0 ;">
            ...
            <div class="row g-5">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100 fac-img-curv" src="img/cusat.jpg" style="object-fit: cover; box-shadow: -5px 5px 5px  #000;" alt="">
                    </div>
                </div>
