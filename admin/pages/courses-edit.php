...
<head>
    ...
    <title>Edit Courses | Shiptech Admin</title>
    <!-- plugins:css -->
                                ...
                                <form class="forms-sample" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="thumbName" name="thumbName"
                                            value="<?php echo htmlentities($userArr[0]->thumb); ?>" />
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" name="CourseseditBTN"
                                        id="CourseseditBTN">Submit</button>
