        ...
        <div class="container-fluid py-5 px-lg-0" style="overflow:hidden;">
                ...
                <div class="row g-5 mx-lg-5">
                    <div class="col-12 mx-lg-2 col-lg-3 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                        ...
                        <div class="card overflow-hidden card1" style="width: 18rem; border-radius: 25px;">
                            <img src="uploads/<?php echo $userArr[0]->image ?>" class="card-img-top img-fluid" style="border-radius: 15px;" alt="faculty image" />
                            ...
                            <div class="card-body ">
                                ...
                                <div class="small-text ">
                                    <div class="row mb-md-3 mb-2">
                                        ...
                                        <div class="col-10 text-right"><a class="white col-11" href="mailto:<?php echo $userArr[0]->email ?>"><?php echo $userArr[0]->email ?></a>
                                        </div>
                                    </div>
                                    <div class="row mb-md-3 mb-2">
                                        <div class="col-2">
            ...
            ?>
                <div class="container my-5 justify-para" style="margin-top: 80px;">
                    ...
                    <?php $MoreFundedProjects = $userArr[0]->otherInfo;
